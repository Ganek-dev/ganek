...
- Write about, review, teach, or link to Ganek using the name and
  unmodified logo.
- Distribute unmodified copies of Ganek.

## Please ask first (or rename)
...
- Modified versions distributed under the Ganek name. Forks are
  welcome and may state they are "a fork of Ganek", but should carry
  their own name and logo.
- Using the name or logo in a way that implies endorsement,
  partnership, or official status.
- Registering domains, company names, social-media handles, or app
  store listings containing "ganek" for software or hiring services.

## Notes

- The wordmark is currently used and claimed as an unregistered mark;
  a registration may follow. This policy applies either way.
- Nominative fair use, comparison, criticism, and news reporting need
  no permission anywhere in this policy.
- Questions or requests: open a GitHub issue or email
